...
do
    ...
    while [[ ${VALUE_NUM} -gt 0 ]] && [[ ${FREE_SIZE} -gt 1048576 ]];
    do
        # create file
        fallocate -l ${FILE_SIZE}KB ${DIR_PATH}${DIR_NAME}${DATE}/${VALUE_NAME}\.${FILE_NAME_END}
